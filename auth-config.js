window.AUTH_CONFIG = {
    ...
    // メールでお知らせ送信用Webhook（任意）。
    // 例: "https://<project-ref>.functions.supabase.co/mail-notice-send"
    // 未設定時は mailto でメール作成画面を開きます。
    mailNoticeWebhookUrl: "https://gnnfzimhfizbfhvwuzbf.functions.supabase.co/mail-notice-send",
